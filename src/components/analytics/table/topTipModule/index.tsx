...
function TopTipByModule({ title, module }: IProps) {
  const intl = useIntl();
  const columns = [
    {
    ...
    {
      title: intl.formatMessage({ id: 'tippingTimes', defaultMessage: 'Tipping Times' }),
      key: 'Tipping Times',
      render: (row) => (
        <span>
...
TopTipByModule.propTypes = {};

export default TopTipByModule;
